...
#load up data:
x, y = utils.load_feature_and_label_matrices(type='cats')
...
np.save('./processed_data/replicate_AVE_cats/aves_before_trim.npy', np.array(aves_before_trim))
np.save('./processed_data/replicate_AVE_cats/aves_after_trim.npy', np.array(aves_after_trim))
np.save('./processed_data/replicate_AVE_cats/auroc_before_trim.npy', np.array(auroc_before_trim))
np.save('./processed_data/replicate_AVE_cats/auroc_after_trim.npy', np.array(auroc_after_trim))
np.save('./processed_data/replicate_AVE_cats/ap_before_trim.npy', np.array(ap_before_trim))
np.save('./processed_data/replicate_AVE_cats/ap_after_trim.npy', np.array(ap_after_trim))
np.save('./processed_data/replicate_AVE_cats/sizes_before_trim.npy', np.array(sizes_before_trim))
np.save('./processed_data/replicate_AVE_cats/sizes_after_trim.npy', np.array(sizes_after_trim))
np.save('./processed_data/replicate_AVE_cats/targets.npy', np.array(targets))
np.save('./processed_data/replicate_AVE_cats/cutoffs.npy', np.array(cutoffs))
