...
aves_before_trim = np.load('./processed_data/graph_cluster_cats/aves_before_trim.npy')
aves_after_trim = np.load('./processed_data/graph_cluster_cats/aves_after_trim.npy')
ap_before_trim = np.load('./processed_data/graph_cluster_cats/ap_before_trim.npy')
ap_after_trim = np.load('./processed_data/graph_cluster_cats/ap_after_trim.npy')
