...
aves_before_trim = np.load('processed_data/temp/aves_before_trim.npy', allow_pickle=True)
aves_after_trim = np.load('processed_data/temp/aves_after_trim.npy', allow_pickle=True)
auroc_before_trim = np.load('processed_data/temp/auroc_before_trim.npy', allow_pickle=True)
auroc_after_trim = np.load('processed_data/temp/auroc_after_trim.npy', allow_pickle=True)
ap_before_trim = np.load('processed_data/temp/ap_before_trim.npy', allow_pickle=True)
ap_after_trim = np.load('processed_data/temp/ap_after_trim.npy', allow_pickle=True)

one_nn_before_trim = np.load('processed_data/temp/one_nn_before.npy', allow_pickle=True)
one_nn_after_trim = np.load('processed_data/temp/one_nn_after.npy', allow_pickle=True)

targets = np.load('processed_data/temp/targets.npy', allow_pickle=True)
cutoffs = np.load('processed_data/temp/cutoffs.npy', allow_pickle=True)
sizes_before_trim = np.load('processed_data/temp/sizes_before_trim.npy', allow_pickle=True)
sizes_after_trim = np.load('processed_data/temp/sizes_after_trim.npy', allow_pickle=True)
...
fig.savefig('./processed_data/temp/auroc_vs_ap_1nn.png')
plt.close(fig)
...
fig.savefig('./processed_data/temp/trim_1nn.png')
plt.close(fig)
...
fig.savefig('./processed_data/supplementary/regression_1nn.png')
plt.close(fig)
