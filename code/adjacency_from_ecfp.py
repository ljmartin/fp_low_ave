...
ecfp_distance_matrix = np.memmap('./processed_data/distance_matrices/morgan_distance_matrix.dat', dtype=np.float16, mode='r', 
...
sparse.save_npz('./processed_data/distance_matrices/wadj_ecfp.npz', sparse.csr_matrix(wdAdj))
